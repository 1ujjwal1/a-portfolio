...
function Bio() {
  return (
    <div className='mt-80'>
        ...
        <p>Currently, pursuing a BTech in <span className='text-blue-300 font-semibold'>Mechanical Engineering with Electrical Vehicles</span></p>
        <p className='mt-10'>A self-taught programmer with over a year of hands on experience in problem solving and application development. Specializing in responsive websites, web apps, and custom software, passionate about delivering seamless digital experiences through clean code and innovative solutions.</p>
    </div>
  )
}
